...
$$
\oint _{\left| z-a \right| =r} \frac{1}{z-a} \, dz=2\pi i 
$$
...
$$
\left| \oint _{\gamma}f_{n}(z) \, dz -\oint _{\gamma}f(z) \, dz   \right|=\left| \oint _{\gamma}f_{n}(z)-f(z) \, dz  \right|
$$
$$
...
$$
\oint _{\gamma}\sum_{n=0}^{\infty}z^{n} \, dz=\sum_{n=0}^{\infty}\oint _{\gamma}z^{n} \, dz 
$$
## Proposition: Integral of Cauchy Kernel
Let $a\in\mathbb{C}$ and $r>0$. If $w\in B_{r}(a)\subset \mathbb{C}$, then
$$
\oint _{\left| z-a \right| =r} \frac{1}{z-w} \, dz=2\pi i 
$$
...
$$
    \oint _{\gamma} \frac{1}{z-w} \, dz=\oint _{\gamma}  \frac{1}{z-a}\sum_{n=0}^{\infty} \left( \frac{w-a}{z-a} \right)^{n} \, dz 
$$
$$
...
$$
$$
    = \int_{0}^{2\pi} -\frac{\delta'(t)}{\delta(t)} \sum_{n=0}^{\infty} (\delta(t))^{n} \, dt = \oint _{\delta} -\frac{1}{z}\sum_{n=0}^{\infty}z^{n} \, dz = \sum_{n=0}^{\infty} \oint _{\delta} -\frac{1}{z} z^{n} \, dz=2\pi i  
$$
## Remark
...
$$
f(w)=\frac{1}{2\pi i} \oint _{\gamma} \frac{f(z)}{z-w} \, dz 
$$
### Proof
