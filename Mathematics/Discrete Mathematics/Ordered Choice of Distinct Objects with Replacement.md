...
This is because the arrangement corresponds to the $r$-tuple in the [[Cartesian Product|cartesian product]] $S^{r}$, and we are finding $\left| S^{r} \right|=\left| S \right|^{r}=m^{r}$
