The eigenspace $V_{\lambda}$ corresponding to an [[Eigenvalues|eigenvalue]] $\lambda$ is the [[Vectorspaces|vector]] [[Subspaces|subspace]] [[Linear Span|spanned]] by the respective [[Eigenvectors|eigenvectors]] 
$$
