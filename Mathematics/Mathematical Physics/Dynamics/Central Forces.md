...
This $\underline{L}\cdot \underline{r}=0$ defines a [[Planes|plane in $\mathbb{R}^{3}$]] through the origin. Importantly this is a constant plane, so the trajectory of the particle lies in this fixed plane, which we can take to be the $xy$-plane
