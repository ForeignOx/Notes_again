...
- A cricket ball is struck from a point $A$ which is $1$m above level horizontal ground with speed of $25$ms$^{-1}$ at an angle of $30^\circ$ to above the horizontal. The ball first hits the ground at a point $B$. The ball is modelled as a particle moving through still air without any resistance. Determi
