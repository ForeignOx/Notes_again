...
What the above example showed is that with Galilean boosts, Maxwell's equations aren't satisfied which is very sad, so we have to throw away Newton's law
