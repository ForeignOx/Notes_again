...
$$
Then we have the first being equivalent to the second, since the sum of non-negative terms is greater than zero iff some term is greater than 0
## Remark
One can show that $\leftrightarrow$ is an [[Equivalence Relation|equivalence relation]] on $I$, meaning that $i\leftrightarrow j$ and $j\leftrightarrow k$ means $i\leftrightarrow k$ for any $i,j,k\in I$
