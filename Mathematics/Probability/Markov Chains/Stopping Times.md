...
Stated in other words, $\left\{ \omega \in \Omega :\middle|: T(\omega)f\leq k \right\}$ can be written as the union of elementary events only involving $X_{0},\dots,X_{k}$ for all $k\geq 0$
## Example
