...
I used this to play around with proteins and generate my own proteins to act as toy models by picking from these different regions corresponding to helices, sheets or the nifty little linker sections
